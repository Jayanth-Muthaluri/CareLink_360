...
public class EmailBillingInformationToPatientJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSendEmail.setBackground(new java.awt.Color(255, 102, 102));
        ...
        btnClearText.setBackground(new java.awt.Color(255, 102, 102));
    ...
    private void SendMail(String toMail, String text) throws MessagingException {
        ...
        String to = toMail;
        final String from = "malleshmanu95@gmail.com";
        final String password = "Manimanu@143";
